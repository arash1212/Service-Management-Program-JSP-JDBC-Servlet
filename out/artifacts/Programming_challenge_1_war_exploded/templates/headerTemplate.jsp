...
<header style="font-size: 90%;">
    <nav class="navbar navbar-expand-sm bg-dark navbar-light" style="color: white">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a style="color: white" class="nav-link" href="/admin/user_role/findAll.do">مدیریت نقش ها (ادمین)</a>
            </li>

            <li class="nav-item">
                <a style="color: white" class="nav-link" href="/admin/ServiceManagment.jsp">افزودن سرویس جدید (ادمین)</a>
            </li>

            <li class="nav-item">
                <a style="color: white" class="nav-link" href="/admin/service/findAll.do">مشاهده لیست سرویس ها (ادمین)</a>
            </li>

            <li class="nav-item">
                <a style="color: white" class="nav-link" href="/service/findAllActiveServices.do">مشاهده لیست سرویس های فعال (عمومی)</a>
            </li>
